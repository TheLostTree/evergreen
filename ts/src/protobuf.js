/**
 * All code in this file is taken from the GCHQ/CyberChef project [1] and has been modified to fit the needs of the
 * project. The original code can be found at [2].
 * [1] https://github.com/gchq/CyberChef
 * [2] https://github.com/gchq/CyberChef/blob/master/src/core/lib/Protobuf.mjs
 * 
 * The following changes have been made:
 * - moved a single function from Utils.js to this file
 * - slightly changed this code to work with require/module.exports instead of import/export
 */
...
class Protobuf {
    ...
    static showRawTypes(rawDecode, fieldTypes) {
        for (const [fieldNum, value] of Object.entries(rawDecode)) {
            ...
            //     repeated: Array.isArray(outputFieldValue),
            //     fieldNum: fieldNum};
    ...
    _lenDelim(fieldNum) {
        ...
        try {
            ...
            field = Protobuf.byteArrayToChars(fieldBytes);
        }
